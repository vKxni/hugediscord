import cmd, discord/[discord, arguments, commands, http, messages, ws], aternos

import strutils, json, asyncdispatch, httpclient, times, uri, tables, random
